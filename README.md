![Tests status](https://github.com/adminui/laravel-eloquent-joins/workflows/Test/badge.svg)

# Laravel Eloquent Joins

This package was introduced as a maintained fork of https://github.com/fico7489/laravel-eloquent-join 
which is no longer being maintained since Laravel 8 in 2020.
...
```
composer require AdminUI/laravel-eloquent-join
```
With this statement, a composer will install highest available package version for your current laravel version.

2.Use AdminUI\Laravel\EloquentJoin\Traits\EloquentJoinTrait trait in your base model or only in particular models.
